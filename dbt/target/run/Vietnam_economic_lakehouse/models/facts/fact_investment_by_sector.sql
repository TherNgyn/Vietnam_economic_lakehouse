        ...
        CREATE TABLE gold_gold.fact_investment_by_sector
        USING DELTA
        AS
...
final as (
    ...
    abs(xxhash64(coalesce(cast(time_key as string), '__null__'), coalesce(cast(sector_key as string), '__null__'), coalesce(cast(unit_key as string), '__null__'), coalesce(cast(source_key as string), '__null__')))
 as fact_investment_by_sector_key,
