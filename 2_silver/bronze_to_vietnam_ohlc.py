...
def write_to_csv(df: pd.DataFrame, symbol: str):
    ...
    try:
        ...
        csv_path = f"s3://{MINIO_BUCKET_SILVER}/vietnam_index/historical/{symbol}/processing_date={processing_date}/{symbol}.csv"
...
def process_vietnam_index_csv(symbol: str, s3_file_path: str, unit: str):
    ...
    try:
        ...
        silver_path = f"s3://{MINIO_BUCKET_SILVER}/vietnam_index/historical/{symbol}"
